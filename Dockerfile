#docker file taken from: https://github.com/NordicPlayground/nrf-docker
...
RUN <<EOT
    apt-get -y update
    apt-get -y upgrade
    apt-get -y install cppcheck g++
EOT

WORKDIR /root/gtest
RUN git clone -b v1.14.x --recursive https://github.com/google/googletest.git
